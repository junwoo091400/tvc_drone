...
find "$TEMPLATE_GNC_PATH" -type f -exec sed -i -e 's/lqr_with_integrator_/'"$packageName"'_/g' {} \;
find "$TEMPLATE_GNC_PATH" -type f -exec sed -i -e 's/Lqr_with_integrator/'"${packageName^}"'/g' {} \;
