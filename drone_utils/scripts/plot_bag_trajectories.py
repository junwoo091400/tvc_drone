...
for topic, msg, t in bag.read_messages(topics=['/drone_state']):
    if msg.header.stamp.to_sec() > time_init and msg.header.stamp.to_sec() < t_end:
        state_array = np.append(msg.header.stamp.to_sec() - time_init, convert_state_to_array(msg))
