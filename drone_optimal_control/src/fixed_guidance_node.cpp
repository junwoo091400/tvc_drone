...
public:
  ...
  const double
      seg_lengths[14] = { 0.5, 1, 1, 1, 1, 0.64, 0.64, 1, 0.3, 1, 1.21 /*ellipse*/, 0.5, 1.3, 2.97 /*ellipse*/ };
  double total_length;
...
int main(int argc, char** argv)
{
  ...
  ros::Timer control_thread =
      nh.createTimer(ros::Duration(0.2), [&](const ros::TimerEvent&) { droneGuidanceNode.run(); });
