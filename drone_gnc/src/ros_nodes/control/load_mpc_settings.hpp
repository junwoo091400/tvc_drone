...
ControlMPCSettings<double> loadMPCSettings(ros::NodeHandle &nh) {
    ...
    if (nh.getParam("mpc/state_costs/x", settings.x_cost) &&
        nh.getParam("mpc/state_costs/dz", settings.dx_cost) &&
        nh.getParam("mpc/state_costs/z", settings.z_cost) &&
        nh.getParam("mpc/state_costs/dz", settings.dz_cost) &&
        ...
        nh.getParam("mpc/min_z", settings.min_z) &&
        nh.getParam("mpc/min_dz", settings.min_dz) &&
        nh.getParam("mpc/max_dx", settings.max_dx) &&
        nh.getParam("mpc/max_dz", settings.max_dz) &&
        nh.getParam("mpc/max_datt", settings.max_datt) &&
        nh.getParam("mpc/scaling_x", settings.scaling_x) &&
        nh.getParam("mpc/scaling_z", settings.scaling_z) &&
        nh.getParam("mpc/weight_scaling", settings.weight_scaling) &&
        ...
        nh.getParam("mpc/period", settings.period) &&
