...
*	- Commanded gimbal state from lqr_control		 /gimbal_command_0
*
	...
	public:
        ...
        void processCommand(const std_msgs::String &command) {
            if (command.data == "stop" || command.data == "Stop") {
                ...
                rocket_fsm.state_machine = rocket_utils::FSM::LAUNCH;
            }
        }
		...
		void updateFSM()
		{
			...
			else
			{
				...
				{
					// End of rail
					if(rocket_state.pose.position.z > rail_length || true)
					{
