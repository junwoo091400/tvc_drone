...
private:
  ...
  _interpreter()
  {
    ...
    if (!s_python_function_show || !s_python_function_close || !s_python_function_draw || !s_python_function_pause ||
        !s_python_function_figure || !s_python_function_fignum_exists || !s_python_function_plot ||
        !s_python_function_quiver || !s_python_function_contour || !s_python_function_colorbar ||
        !s_python_function_semilogx || !s_python_function_semilogy || !s_python_function_loglog ||
        !s_python_function_fill || !s_python_function_fill_between || !s_python_function_subplot ||
        !s_python_function_legend || !s_python_function_ylim || !s_python_function_title || !s_python_function_axis ||
        !s_python_function_xlabel || !s_python_function_ylabel || !s_python_function_xticks ||
        !s_python_function_yticks || !s_python_function_xscale || !s_python_function_yscale ||
        !s_python_function_grid || !s_python_function_xlim || !s_python_function_ion || !s_python_function_ginput ||
        ...
        !s_python_function_stem || !s_python_function_xkcd || !s_python_function_text || !s_python_function_suptitle ||
        !s_python_function_bar || !s_python_function_subplots_adjust || !s_python_function_spy ||
    ...
    if (!PyFunction_Check(s_python_function_show) || !PyFunction_Check(s_python_function_close) ||
        ...
        !PyFunction_Check(s_python_function_contour) || !PyFunction_Check(s_python_function_semilogx) ||
        !PyFunction_Check(s_python_function_semilogy) || !PyFunction_Check(s_python_function_loglog) ||
        !PyFunction_Check(s_python_function_fill) || !PyFunction_Check(s_python_function_fill_between) ||
        ...
        !PyFunction_Check(s_python_function_ylabel) || !PyFunction_Check(s_python_function_xticks) ||
        !PyFunction_Check(s_python_function_yticks) || !PyFunction_Check(s_python_function_xscale) ||
        !PyFunction_Check(s_python_function_yscale) || !PyFunction_Check(s_python_function_grid) ||
        ...
        !PyFunction_Check(s_python_function_subplots_adjust) || !PyFunction_Check(s_python_function_imshow) ||
...
bool plot_base(PyObject* const pyfunc, const VectorX& x, const VectorY& y, const std::string& s = "",
...
template <typename VectorX, typename VectorY>
bool loglog(const VectorX& x, const VectorY& y, const std::map<std::string, std::string>& keywords)
{
...
bool semilogx(const VectorX& x, const VectorY& y, const std::string& s = "",
              const std::map<std::string, std::string>& keywords = {})
{
  return detail::plot_base(detail::_interpreter::get().s_python_function_semilogx, x, y, s, keywords);
}

template <typename VectorX, typename VectorY>
bool semilogx(const VectorX& x, const VectorY& y, const std::map<std::string, std::string>& keywords)
{
...
bool semilogy(const VectorX& x, const VectorY& y, const std::string& s = "",
              const std::map<std::string, std::string>& keywords = {})
{
  return detail::plot_base(detail::_interpreter::get().s_python_function_semilogy, x, y, s, keywords);
}

template <typename VectorX, typename VectorY>
bool semilogy(const VectorX& x, const VectorY& y, const std::map<std::string, std::string>& keywords)
{
...
void imshow(const Matrix& X, const std::map<std::string, std::string>& keywords = {})
{
  ...
  PyObject* res = PyObject_Call(detail::_interpreter::get().s_python_function_imshow, plot_args, kwargs);
...
void colorbar()
{
  PyObject* res = PyObject_CallObject(detail::_interpreter::get().s_python_function_colorbar,
                  ...
                  const std::map<std::string, std::string>& keywords = std::map<std::string, std::string>())
{
  ...
  PyObject* python_colormap_coolwarm = PyObject_GetAttrString(detail::_interpreter::get().s_python_colormap, "coolwar"
                                                                                                             "m");
...
// @param keywords Additional keywords
template <typename Matrix>
void contour(const Matrix& x, const Matrix& y, const Matrix& z, const std::map<std::string, std::string>& keywords = {})
{
  detail::_interpreter::get();
...
bool hist(const VectorY& y, long bins = 10, std::string color = "b", double alpha = 1.0, bool cumulative = false)
{
  PyObject* yarray = get_array(y);
...
template <typename VectorX, typename VectorY>
bool scatter(const VectorX& x, const VectorY& y, const std::map<std::string, std::string>& keywords)
{
...
void axhline(const NumericY y, const std::map<std::string, std::string> keywords = {})
{
  ...
  PyObject* res = PyObject_Call(detail::_interpreter::get().s_python_function_axhline,
...
void axvline(const NumericX x, const std::map<std::string, std::string> keywords = {})
{
  ...
  PyObject* res = PyObject_Call(detail::_interpreter::get().s_python_function_axvline,
                                detail::_interpreter::get().s_python_empty_tuple, kwargs);
...
template <typename Vector>
inline void legend(const Vector& bbox_to_anchor, const std::map<std::string, std::string>& keywords = {})
{
  legend("", bbox_to_anchor, keywords);
}

inline void legend(const std::string& loc, const std::map<std::string, std::string>& keywords = {})
{
