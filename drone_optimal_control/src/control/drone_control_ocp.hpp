...
POLYMPC_FORWARD_DECLARATION(/*Name*/ DroneControlOCP, /*NX*/ 15, /*NU*/ 4, /*NP*/ 0, /*ND*/ 0, /*NG*/ 3,
                            /*TYPE*/ double)
...
public:
  ...
  void init(Drone* drone_, ControlMPCSettings<scalar_t>& settings_)
  {
    ...
    Q << settings.x_cost, settings.x_cost, settings.z_cost, settings.dx_cost, settings.dx_cost, settings.dz_cost,
        settings.att_cost, settings.att_cost, settings.datt_cost, settings.datt_cost, settings.droll_cost;
    ...
    x_unscaling_vec << settings.scaling_x, settings.scaling_x, settings.scaling_z, settings.max_dx, settings.max_dx,
        settings.max_dz, 1, 1, 1, 1, settings.max_datt, settings.max_datt, settings.max_datt,
        drone->props.max_servo1_angle, drone->props.max_servo2_angle;
    u_unscaling_vec << drone->props.max_servo_rate, drone->props.max_servo_rate, drone->props.max_propeller_speed,
        drone->props.max_propeller_delta / 2;
