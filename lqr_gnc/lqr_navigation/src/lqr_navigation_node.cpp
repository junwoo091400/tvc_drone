...
public:
    ...
    RocketNavigationNode() :
        ...
        LqrNavigation::Config nav_config;
        ...
        navigation = std::unique_ptr<LqrNavigation>(new LqrNavigation(nav_config, rocket_props));
...
private:
    std::unique_ptr<LqrNavigation> navigation;
