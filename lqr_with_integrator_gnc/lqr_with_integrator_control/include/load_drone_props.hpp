...
DroneProps<double> loadDroneProps(ros::NodeHandle &nh) {
    ...
    if (nh.getParam("/rocket/min_propeller_speed", props.min_propeller_speed) &&
        ...
        nh.getParam("/rocket/CM_to_thrust_distance", props.total_CM) &&
        ...
        props.servo1_offset = servo1_offset_degree * M_PI / 180.0;
        props.servo2_offset = servo2_offset_degree * M_PI / 180.0;
